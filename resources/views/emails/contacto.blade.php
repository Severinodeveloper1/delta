    ...
    <div
        ...
        <div style="padding: 20px; line-height: 1.6; color: #333333;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #eeeeee; font-weight: bold; width: 150px;">Nombre:
                    </td>
                ...
                @if (isset($datos['especialista']))
                    <tr>
                        <td style="padding: 8px; border-bottom: 1px solid #eeeeee; font-weight: bold;">Especialista:
                        </td>
                ...
                @endif
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #eeeeee; font-weight: bold; vertical-align: top;">
                        Mensaje:</td>

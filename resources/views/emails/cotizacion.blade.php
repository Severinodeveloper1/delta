    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #dddddd; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
        ...
        <div style="padding: 20px; line-height: 1.6; color: #333333;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #eeeeee; font-weight: bold; width: 150px;">Producto:</td>
                ...
                <tr>
                    ...
                    <td style="padding: 8px; border-bottom: 1px solid #eeeeee;">US$ {{ number_format($datos['precio'], 2) }}</td>
                </tr>
                @endif
                ...
                @endif
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #eeeeee; font-weight: bold; font-size: 14px; color: #f97316;" colspan="2"><br>DATOS DEL INTERESADO</td>
                </tr>
                <tr>

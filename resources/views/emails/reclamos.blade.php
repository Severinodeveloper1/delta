...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    <div
        style="max-width: 650px; margin: 0 auto; background-color: #ffffff; border: 1px solid #dddddd; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
        <!-- Header -->
        ...
        <div style="padding: 20px; line-height: 1.6; color: #333333;">
            ...
            <h4 style="color: #dc2626; border-bottom: 2px solid #eeeeee; padding-bottom: 5px;">1. Datos del Consumidor
            </h4>
            ...
            <h4 style="color: #dc2626; border-bottom: 2px solid #eeeeee; padding-bottom: 5px;">3. Detalle de Reclamación
            </h4>
        ...
        <div
            ...
            Este mensaje fue generado automáticamente por el Libro de Reclamaciones de IMPORTACIONES DELTA PERU S.A.C.
        </div>
    </div>
</body>
